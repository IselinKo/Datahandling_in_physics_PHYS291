...
{
   TASImage roseimage("rose256.jpg");
   ...
   TCanvas *canv1 = new TCanvas("canv1","Image.Draw()",100,100,700,600);
   TCanvas *canv2 = new TCanvas("canv2","roses_colz",300,150,700,600);
   TCanvas *canv3 = new TCanvas("canv3","roses_surf6",500,200,700,600);
   TCanvas *canv4 = new TCanvas("canv4","roses_surf6_rotate",700,250,700,600);
